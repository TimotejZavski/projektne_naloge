...
| `GET` | `/api/devices/:deviceId` | Naprava z zadnjimi meritvami prek `$lookup` |
...
| `GET` | `/api/:collection` | Varovan fallback za dovoljene kolekcije |
| `GET` | `/api/:collection/:id` | Branje posameznega dokumenta po Mongo `_id` |
